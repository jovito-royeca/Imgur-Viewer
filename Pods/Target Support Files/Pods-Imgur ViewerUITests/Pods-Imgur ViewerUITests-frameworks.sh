...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Imgur ViewerUITests/NSEntityDescription_SYNCPrimaryKey.framework"
  install_framework "Pods-Imgur ViewerUITests/NSManagedObject_HYPPropertyMapper.framework"
  install_framework "Pods-Imgur ViewerUITests/NSString_HYPNetworking.framework"
  install_framework "Pods-Imgur ViewerUITests/SDWebImage.framework"
  install_framework "Pods-Imgur ViewerUITests/Sync.framework"
  install_framework "Pods-Imgur ViewerUITests/TLYShyNavBar.framework"
fi
