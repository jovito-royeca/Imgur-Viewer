...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Imgur Viewer/NSEntityDescription_SYNCPrimaryKey.framework"
  install_framework "Pods-Imgur Viewer/NSManagedObject_HYPPropertyMapper.framework"
  install_framework "Pods-Imgur Viewer/NSString_HYPNetworking.framework"
  install_framework "Pods-Imgur Viewer/SDWebImage.framework"
  install_framework "Pods-Imgur Viewer/Sync.framework"
  install_framework "Pods-Imgur Viewer/TLYShyNavBar.framework"
fi
